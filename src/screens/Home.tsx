...
const amountOfDaysToCompleteLine = (datesFromYearBeginning.length % 7 === 0) ? 0 : 7 - (datesFromYearBeginning.length % 7);
                    ...
                    <View className="flex-row flex-wrap">
                        ...
                        .map((_, i) => {
                            return (
                                <View
                                    key={i}
                                    className='bg-zinc-900 rounded-lg border m-1 border-zinc-800 opacity-40'
                                    style={{width: DAY_SIZE, height: DAY_SIZE}}
                                >
                                </View>
                            );
                        }) : Array
                        .from({ length: amountOfDaysToCompleteLine })
                        .map((_, i) => {
                            return (
                                <View
                                    key={i}
